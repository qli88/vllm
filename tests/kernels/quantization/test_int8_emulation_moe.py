...
Tests:
  ...
  - Int8EmulationTritonExperts end-to-end forward pass
...
pytestmark = pytest.mark.skipif(
    ...
    reason="Int8EmulationTritonExperts requires CUDA.",
)
...
def test_int8_emulation_forward_close_to_reference(
    ...
    assert rel_l2 < 0.05, f"[{model_dtype}] relative L2 = {rel_l2:.4f} (threshold 0.05)"
...
def test_int8_emulation_fp16_bf16_agree(E, K, N, top_k, group_size, num_tokens):
    ...
    assert rel_l2 < 0.02, f"bf16 vs fp16 relative L2 = {rel_l2:.4f} (threshold 0.02)"
