...
Weight layout (GPTQ int8, pack_factor=4):
  w_int32: [E, K_packed, N]  int32   K_packed = K // 4
           packed LSB-first along K: byte 0 = row j*4+0, byte 1 = row j*4+1, ...
  scale:   [E, K//group_size, N]  float16 | bfloat16
"""
